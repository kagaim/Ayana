jQuery('document').load(function(){
	...
	// Audio metabox
	jQuery('input[name=kgm_ayana_audio_host_type]').on('change', function(){
		var audio_host_type = jQuery('input[name=kgm_ayana_audio_host_type]:checked').val();
	...
	jQuery('input[name=kgm_ayana_audio_host_type]').trigger('change');

	// Video metabox
	jQuery('input[name=kgm_ayana_video_host_type]').on('change', function(){
		var video_host_type = jQuery('input[name=kgm_ayana_video_host_type]:checked').val();
	...
	jQuery('input[name=kgm_ayana_video_host_type]').trigger('change');
